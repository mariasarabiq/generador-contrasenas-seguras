  Caracteristica: Generador y Validador de Contraseñas Seguras
  ...
  Escenario: Generar opciones de contraseñas seguras con una palabra válida
    Dado que el usuario se encuentra en la sección "Generador de Contraseñas Seguras"
    Cuando introduce la palabra "mariposa" en la caja de texto principal
    Entonces el sistema debe generar 3 opciones de contraseña
  ...
  Escenario: Intento de generar contraseñas dejando el campo vacío
    Dado que el usuario se encuentra en la sección "Generador de Contraseñas Seguras"
    Cuando el usuario deja la caja de texto en blanco
